module BraintreeRails
  class CreditCardValidator < Validator
    Validations = [
      ...
      [:expiration_month, :presence => true, :if => Proc.new { |credit_card| credit_card.expiration_date.blank? }],
      [:expiration_year, :presence => true, :if => Proc.new { |credit_card| credit_card.expiration_date.blank? }],
      [:expiration_date, :presence => true, :if => Proc.new { |credit_card| credit_card.expiration_month.blank? }],
